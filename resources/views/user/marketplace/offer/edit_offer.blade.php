                ...
                <div class="card-body">
                    <ul class="nav cp-user-profile-nav" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" style="margin-left: 45%;">
                            <a class="nav-link active" data-id="buy-tab"
                        ...
                        @else
                        <li class="nav-item" style="margin-left: 45%;">
                            <a class="nav-link active" data-id="sell-tab"
                            ...
                            <span class="cp-user-img">
                                ...
                                {{__('Update SELL Offer')}}
                            </a>
                        </li>
                        @endif
                    </ul>
                    <div class="tab-content cp-invite-contact-tab-content col-6" style="margin-left: 25%;" id="pills-tabContent">
                        @include('user.marketplace.offer.include.edit_offer')
                    </div>
                </div>
            </div>
        </div>
