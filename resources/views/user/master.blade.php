                    ...
                    <ul>
                        <li class="@if(isset($menu) && $menu == 'dashboard') cp-user-active-page @endif">
                            <a href="{{route('userDashboard')}}">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_dashboard'] ?? 'Dashboard') }} </span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'pocket') cp-user-active-page @endif">
                            <a href="{{route('myPocket')}}">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_wallet'] ?? 'My Wallet') }}</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'marketplace') cp-user-active-page @endif">
                            ...
                            <span class="cp-user-icon">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_exchange'] ?? 'Crypto Exchange') }}</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'offer') cp-user-active-page @endif">
                            ...
                            <span class="cp-user-icon">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_offer'] ?? 'My Offer') }}</span>
                            </a>
                        </li>
                        <li class=" @if(isset($menu) && $menu == 'trade') cp-user-active-page @endif">
                            ...
                            <span class="cp-user-icon">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_trade_list'] ??  'My Trade List') }}</span>
                            </a>
                        </li>
                        @if(admin_feature_enable('buy_coin_feature'))
                            <li class="@if(isset($menu) && $menu == 'buy_coin') cp-user-active-page mm-active @endif">
                                <a class="arrow-icon" href="#" aria-expanded="true">
                                    ...
                                    <span class="cp-user-name">{{ __($navber['user_nav_buy_coin'] ?? 'Buy Coin')}}</span>
                                </a>
                                <ul class="@if(isset($menu) && $menu == 'buy_coin')  mm-show  @endif">
                                    <li class="@if(isset($sub_menu) && $sub_menu == 'buy_coin') cp-user-submenu-active @endif">
                                        <a href="{{route('buyCoinPage')}}">{{ __($navber['user_navSub_buy_coin'] ??  'Buy Coin') }}</a>
                                    </li>
                                    <li class="@if(isset($sub_menu) && $sub_menu == 'buy_coin_history') cp-user-submenu-active @endif">
                                        <a href="{{route('buyCoinHistory')}}">{{ __($navber['user_navSub_buy_coin_history'] ?? 'Buy Coin History') }}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        <li class="@if(isset($menu) && $menu == 'referral') cp-user-active-page @endif">
                            ...
                            <span class="cp-user-icon">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_referral'] ?? 'My Referral') }}</span>
                            </a>
                        </li>
                        <li class="@if(isset($menu) && $menu == 'setting') cp-user-active-page mm-active @endif">
                            <a class="arrow-icon" href="#" aria-expanded="true">
                                ...
                                <span class="cp-user-name">{{ __($navber['user_nav_setting'] ?? 'Settings') }}</span>
                            </a>
                            <ul class="@if(isset($menu) && $menu == 'setting')  mm-show  @endif">
                                <li class="@if(isset($sub_menu) && $sub_menu == 'setting') cp-user-submenu-active @endif">
                                    <a href="{{route('userSetting')}}">{{ __($navber['user_navSub_setting'] ?? 'My Settings') }}</a>
                                </li>
                                <li class="@if(isset($sub_menu) && $sub_menu == 'faq') cp-user-submenu-active @endif">
                                    <a href="{{route('userFaq')}}">{{ __($navber['user_navSub_faq'] ?? 'FAQ') }}</a>
                                </li>
                            </ul>
                        </li>
                        @if(empty(Auth::user()))
                            <li class="">
                                <a href="{{route('login')}}">
                                    ...
                                    <span class="cp-user-name">{{ __($navber['user_nav_login'] ?? 'Login') }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
                        ...
                        <li>
                            ...
                            <div class="btn-group profile-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <button class="dropdown-item" type="button"><a href="{{route('userPaymentMethodList')}}"><i class="fa fa-money"></i> {{__('My Payment Method')}}</a></button>
