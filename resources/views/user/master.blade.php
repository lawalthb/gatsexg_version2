...
<head>
    ...
    <style>
        :root {
            --navbar-background-color: {{ $userThemeColor['user_theme_navbar_background_color'] }};
            --navbar-menu-text-color: {{ $userThemeColor['user_theme_navbar_menu_text_color'] }};
            --navbar-menu-active-text-color: {{ $userThemeColor['user_theme_navbar_active_menu_text_color'] }};
            --body-background-color: {{ $userThemeColor['user_theme_body_background_color'] }};
            --card-body-background-color: {{ $userThemeColor['user_theme_card_body_background_color'] }};
            --primary-text-color: {{ $userThemeColor['user_theme_primary_text_color'] }};
            --secondary-text-color: {{ $userThemeColor['user_theme_secondary_text_color'] }};
            --warning-text-color: {{ $userThemeColor['user_theme_warning_text_color'] }};
            --link-text-color: {{ $userThemeColor['user_theme_link_text_color'] }};
            --button-text-color: {{ $userThemeColor['user_theme_button_text_color'] }};
            --button-background-color: {{ $userThemeColor['user_theme_button_background_color'] }};
            --active-button-background-color: {{ $userThemeColor['user_theme_active_button_background_color'] }};
...
<body class="cp-user-body-bg">
    ...
    <div class="header-middle">
        <div class="container-fuild">
            <div class="row align-items-center">
                ...
                @if (Auth::user())
                    @php
                        $notifications = \App\Model\Notification::where(['user_id' => Auth::user()->id, 'status' => 0])
                            ->orderBy('id', 'desc')
                            ->get();
                        $navber = settings();
                    @endphp
                        ...
                        <ul>
                            <li class="@if (isset($menu) && $menu == 'dashboard') cp-user-active-page @endif">
                                <a href="{{ route('userDashboard') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/dashboard.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/dashboard.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span class="cp-user-name">{{ __($navber['user_nav_dashboard'] ?? 'Dashboard') }}
                                    </span>
                                </a>
                            </li>
                            <li class="@if (isset($menu) && $menu == 'pocket') cp-user-active-page @endif">
                                <a href="{{ route('myPocket') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/Wallet.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/Wallet.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_wallet'] ?? 'My Wallet') }}</span>
                                </a>
                            </li>
                            <li class="@if (isset($menu) && $menu == 'marketplace') cp-user-active-page @endif">
                                <a href="{{ route('marketPlace') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/002-Crypto-exchange-1.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/002-Crypto-exchange.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_exchange'] ?? 'Crypto Exchange') }}</span>
                                </a>
                            </li>
                            <li class="@if (isset($menu) && $menu == 'offer') cp-user-active-page @endif">
                                <a href="{{ route('myOffer') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/My-Offer-1.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/Offer.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_offer'] ?? 'My Offer') }}</span>
                                </a>
                            </li>
                            <li class=" @if (isset($menu) && $menu == 'trade') cp-user-active-page @endif">
                                <a href="{{ route('myTradeList') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/Trade-1.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/Trade-1.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_trade_list'] ?? 'My Trade List') }}</span>
                                </a>
                            </li>
                            @if (admin_feature_enable('buy_coin_feature'))
                                <li class="@if (isset($menu) && $menu == 'buy_coin') cp-user-active-page mm-active @endif">
                                    <a class="arrow-icon" href="#" aria-expanded="true">
                                        <span class="cp-user-icon">
                                            <img src="{{ asset('assets/user/images/sidebar-icons/icon.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon" alt="">
                                            <img src="{{ asset('assets/user/images/sidebar-icons/hover/icon.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                        </span>
                                        <span
                                            class="cp-user-name">{{ __($navber['user_nav_buy_coin'] ?? 'Buy Coin') }}</span>
                                    </a>
                                    <ul class="@if (isset($menu) && $menu == 'buy_coin') mm-show @endif">
                                        <li class="@if (isset($sub_menu) && $sub_menu == 'buy_coin') cp-user-submenu-active @endif">
                                            <a
                                                href="{{ route('buyCoinPage') }}">{{ __($navber['user_navSub_buy_coin'] ?? 'Buy Coin') }}</a>
                                        </li>
                                        <li class="@if (isset($sub_menu) && $sub_menu == 'buy_coin_history') cp-user-submenu-active @endif">
                                            <a
                                                href="{{ route('buyCoinHistory') }}">{{ __($navber['user_navSub_buy_coin_history'] ?? 'Buy Coin History') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            <style>
                                .change2white {
                                    ...
                                    filter: invert(100%) sepia(100%) hue-rotate(86deg) brightness(100%) contrast(100%);
                                }
                            </style>
                            @if (Auth::user())
                                <li class="@if (isset($menu) && $menu == 'Transfer') cp-user-active-page @endif">
                                    <a href="{{ route('transferCoin') }}">
                                        <span class="cp-user-icon">
                                            <img src="{{ asset('assets/user/images/sidebar-icons/mobile-money-transfer-icon.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon change2white" alt="">
                                            <img src="{{ asset('assets/user/images/sidebar-icons/hover/mobile-money-transfer-icon.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon-hover change2white"
                                                alt="">
                                        </span>
                                        <span class="cp-user-name">Transfer</span>
                                    </a>
                                </li>
                            @endif
                            <li class="@if (isset($menu) && $menu == 'referral') cp-user-active-page @endif">
                                <a href="{{ route('myReferral') }}">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/004-share-1.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/004-share.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_referral'] ?? 'My Referral') }}</span>
                                </a>
                            </li>
                            <li class="@if (isset($menu) && $menu == 'setting') cp-user-active-page mm-active @endif">
                                <a class="arrow-icon" href="#" aria-expanded="true">
                                    <span class="cp-user-icon">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/settings.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon" alt="">
                                        <img src="{{ asset('assets/user/images/sidebar-icons/hover/settings.svg') }}"
                                            class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                    </span>
                                    <span
                                        class="cp-user-name">{{ __($navber['user_nav_setting'] ?? 'Settings') }}</span>
                                </a>
                                <ul class="@if (isset($menu) && $menu == 'setting') mm-show @endif">
                                    <li class="@if (isset($sub_menu) && $sub_menu == 'setting') cp-user-submenu-active @endif">
                                        <a
                                            href="{{ route('userSetting') }}">{{ __($navber['user_navSub_setting'] ?? 'My Settings') }}</a>
                                    </li>
                                    <li class="@if (isset($sub_menu) && $sub_menu == 'faq') cp-user-submenu-active @endif">
                                        <a
                                            href="{{ route('userFaq') }}">{{ __($navber['user_navSub_faq'] ?? 'FAQ') }}</a>
                                    </li>
                                </ul>
                            </li>
                            @if (empty(Auth::user()))
                                <li class="">
                                    <a href="{{ route('login') }}">
                                        <span class="cp-user-icon">
                                            <img src="{{ asset('assets/admin/images/sidebar-icons/user.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon" alt="">
                                            <img src="{{ asset('assets/admin/images/sidebar-icons/user.svg') }}"
                                                class="img-fluid cp-user-side-bar-icon-hover" alt="">
                                        </span>
                                        <span
                                            class="cp-user-name">{{ __($navber['user_nav_login'] ?? 'Login') }}</span>
                                    </a>
                                </li>
                            @endif
                        </ul>
                        ...
                        <ul>
                            <li class="hm-notify" id="notification_item">
                                <div class="btn-group dropdown">
                                    <button type="button" class="btn notification-btn dropdown-toggle"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="notify-value hm-notify-number">
                                        ...
                                        <img src="{{ asset('assets/img/icons/notification.png') }}" class="img-fluid"
                                            alt="">
                                    </button>
                                    @if (isset($notifications[0]))
                                        <div class="dropdown-menu notification-list dropdown-menu-right">
                                            <div class="text-center p-2 border-bottom nt-title">
                                                {{ __('New Notifications') }}</div>
                                            <ul class="scrollbar-inner">
                                                @foreach ($notifications as $item)
                                                    <li>
                                                        <a href="javascript:void(0);" data-toggle="modal"
                                                            data-id="{{ $item->id }}"
                                                            data-target="#notificationShow"
                                                            class="dropdown-item viewNotice">
                                                            <span
                                                                class="small d-block">{{ date('d M y', strtotime($item->created_at)) }}</span>
                                                            {!! clean($item->title) !!}
                                                        </a>
                                                    </li>
                                                @endforeach
                                    ...
                                    @else
                                        <div class="dropdown-menu notification-list dropdown-menu-right">
                                            <div class="text-center p-2 border-bottom nt-title">
                                                {{ __('No New Notification Found') }}</div>
                                        </div>
                                    @endif
                                </div>
                            </li>
                                    ...
                                    <div class="btn-group profile-dropdown">
                                        <button type="button" class="btn dropdown-toggle" data-toggle="dropdown"
                                            ...
                                            <span class="cp-user-avater">
                                                <span class="cp-user-img">
                                                    <img src="{{ show_image(Auth::user()->id, 'user') }}"
                                                        class="img-fluid" alt="">
                                                </span>
                                            </span>
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <button class="dropdown-item" type="button"><a
                                                    href="{{ route('userProfile') }}"><i
                                                        class="fa fa-user-circle-o"></i>
                                                    {{ __('Profile') }}</a></button>
                                            <button class="dropdown-item" type="button"><a
                                                    href="{{ route('userSetting') }}"><i class="fa fa-cog"></i>
                                                    {{ __('My Settings') }}</a></button>
                                            <button class="dropdown-item" type="button"><a
                                                    href="{{ route('userPaymentMethodList') }}"><i
                                                        class="fa fa-money"></i>
                                                    {{ __('My Payment Method') }}</a></button>
                                            <button class="dropdown-item" type="button"><a
                                                    href="{{ route('myPocket') }}"><i class="fa fa-credit-card"></i>
                                                    {{ __('My Wallet') }}</a></button>
                                            <button class="dropdown-item" type="button"><a
                ...
                <ul id="metismenu">
                    ...
                    <li class="@if (isset($menu) && $menu == 'profile') cp-user-active-page @endif">
                        <a href="{{ route('userProfile') }}">
                            <span class="cp-user-icon">
                                <img src="{{ asset('assets/user/images/sidebar-icons/user.svg') }}"
                                    class="img-fluid cp-user-side-bar-icon" alt="">
                                <img src="{{ asset('assets/user/images/sidebar-icons/hover/user.svg') }}"
                                    class="img-fluid cp-user-side-bar-icon-hover" alt="">
                            </span>
    ...
    <div class="modal fade" id="notificationShow" tabindex="-1" role="dialog"
