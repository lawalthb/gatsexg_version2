        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav user-management-nav mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="@if(isset($tab) && $tab=='font') active @endif nav-link " id="pills-email-tab"
                           data-toggle="pill" data-controls="others_api" href="#others_api" role="tab"
                           aria-controls="pills-email" aria-selected="true">
                            <span>{{__('Others API')}}</span>
                        </a>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane @if(isset($tab) && $tab=='others_api') show active @endif" id="others_api"
                         role="tabpanel" aria-labelledby="pills-email-tab">
                        @include('admin.settings.setting.others')
                    </div>
                </div>
            </div>
        </div>
