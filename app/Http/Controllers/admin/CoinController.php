...
use App\Jobs\UpdateCoinRateJob;
...
class CoinController extends Controller
{
    ...
    public function adminCoinUpdate(Request $request)
    {
        try {
            ...
            $input['rate'] = isset($request->rate) ? $request->rate : 1;
    ...
    {
        dispatch(new UpdateCoinRateJob());
//        $response = $currency->updateCoinRate();
        return redirect()->back()->with("success",__('Update process goes to queue, please wait sometimes'));
    }
