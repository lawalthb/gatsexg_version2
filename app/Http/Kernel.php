...
use App\Http\Middleware\BuyCoinFeature;
...
use App\Http\Middleware\permission_check;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'phone.verify' => CheckPhoneVerification::class,
        'feature.buy_coin' => BuyCoinFeature::class,
        'permission' => permission_check::class,
        'check_demo' => CheckDemo::class
    ];
