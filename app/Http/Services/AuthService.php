...
class AuthService
{
    ...
    function __construct()
    {
        ...
        $this->affiliateService = new AffiliateRepository();
    }
    ...
    public function signUpProcess($request)
    {
        ...
        try {
            ...
            if ($request->has('ref_code')) {
                ...
                if (!$parentUser) {
                    return ['success' => false, 'message' => __('Invalid referral code.')];
                } else {
            ...
            DB::rollback();
            $data = ['success' => false, 'data' => [], 'message' => __('Something went wrong, sign up failed')];
        }
        return $data;
    }
    // user create data
    public function userCreateData($request)
    {
        return [
