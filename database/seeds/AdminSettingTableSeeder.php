...
class AdminSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AdminSetting::firstOrCreate(['slug' => 'google_recapcha'], ['value' => 0]);

        AdminSetting::firstOrCreate(['slug' => 'phone_verification_trade'], ['value' => 0]);

        AdminSetting::firstOrCreate(['slug' => 'dispute_cancel_time'], ['value' => 15]);

        AdminSetting::firstOrCreate(['slug' => 'user_theme_navbar_menu_text_color'], ['value' => '#5B5B5B']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_navbar_active_menu_text_color'], ['value' => '#FC541F']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_navbar_background_color'], ['value' => '#ffffff']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_body_background_color'], ['value' => '#EEF0F8']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_card_body_background_color'], ['value' => '#ffffff']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_primary_text_color'], ['value' => '#575a63']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_secondary_text_color'], ['value' => '#656b96']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_warning_text_color'], ['value' => '#ffc107']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_link_text_color'], ['value' => '#dc8725']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_button_text_color'], ['value' => '#ffffff']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_button_background_color'], ['value' => '#50525a']);
        AdminSetting::firstOrCreate(['slug' => 'user_theme_active_button_background_color'], ['value' => '#28a745']);
    }
}
